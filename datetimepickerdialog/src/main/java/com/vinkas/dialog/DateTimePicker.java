...
public class DateTimePicker implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    public DateTimePicker(Context context, DatePickerDialog.OnDateSetListener dateSetListener, TimePickerDialog.OnTimeSetListener timeSetListener) {
    ...
    public DateTimePicker(Context context, DatePickerDialog.OnDateSetListener dateSetListener, TimePickerDialog.OnTimeSetListener timeSetListener, long timestamp) {
        calendar = Calendar.getInstance();
        this.dateSetListener = dateSetListener;
        this.timeSetListener = timeSetListener;
